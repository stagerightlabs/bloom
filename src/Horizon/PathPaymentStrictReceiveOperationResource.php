...
class PathPaymentStrictReceiveOperationResource extends OperationResource
{
    /**
     ...
     * @return ScaledAmount|null
     */
    public function getSourceMaximum(): ?ScaledAmount
    {
        if ($max = $this->payload->getString('source_max')) {
            return ScaledAmount::of($max);
        }
