...
final class PathPaymentStrictReceiveOp implements XdrStruct, OperationVariety
{
    /**
     * Properties
     */
    ...
    protected Int64 $sendMax; // the amount of the sending asset to be delivered, excluding fees
    protected MuxedAccount $destination; // recipient of the payment
    protected Asset $destAsset; // the asset they will be paid with
    protected Int64 $destAmount; // the amount of the destination asset they will receive
    protected PathPaymentAssetList $path;  // additional conversion hops to be taken, if any

    /**
     * Create a new path-payment-strict-receive operation.
     *
     * @param Asset|string $sendingAsset
     * @param Int64|ScaledAmount|integer|string $sendingMaximum
     * @param MuxedAccount|AccountId|Addressable|string $destination
     * @param Asset|string $destinationAsset
     * @param Int64|ScaledAmount|integer|string $destinationAmount
    ...
    public static function operation(
        ...
        $pathPaymentStrictReceiveOp = (new static())
            ...
            ->withSendingMaximum($sendingMaximum)
        ...
        return (new Operation())
            ->withBody(OperationBody::make(OperationType::PATH_PAYMENT_STRICT_RECEIVE, $pathPaymentStrictReceiveOp))
    ...
    public static function newFromXdr(XDR &$xdr): static
    {
        ...
        $pathPaymentStrictReceiveOp->sendMax = $xdr->read(Int64::class);
        ...
        $pathPaymentStrictReceiveOp->destAmount = $xdr->read(Int64::class);
    ...
    /**
     * Get the maximum amount to be sent.
     *
     * @return Int64
     */
    public function getSendingMaximum(): Int64
    {
        return $this->sendMax;
    }

    /**
     * Accept a maximum amount to be sent.
     *
     * A string will be read as a scaled amount; an integer as a descaled value.
     *
     * @param Int64|ScaledAmount|int|string $sendMax
     * @return static
     */
    public function withSendingMaximum(Int64|ScaledAmount|int|string $sendMax): static
    {
        /** @var static */
        $clone = Copy::deep($this);
        $clone->sendMax = Int64::normalize($sendMax);
     ...
     * @return Int64
     */
    public function getDestinationAmount(): Int64
    {
        return $this->destAmount;
    }

    /**
     * Accept a destination amount.
     *
     * A string will be read as a scaled amount; an integer as a descaled value.
     *
     * @param Int64|ScaledAmount|int|string $destAmount
     * @return static
     */
    public function withDestinationAmount(Int64|ScaledAmount|int|string $destAmount): static
    {
        /** @var static */
        $clone = Copy::deep($this);
        $clone->destAmount = Int64::normalize($destAmount);
