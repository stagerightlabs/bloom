...
final class ClaimClaimableBalanceOp implements XdrStruct, OperationVariety
{
    /**
     * Properties
     */
    ...
    public static function operation(
        ...
        $claimClaimableBalanceOp = (new static())
            ->withBalanceId($balanceId);

        return (new Operation())
            ->withBody(OperationBody::make(OperationType::CLAIM_CLAIMABLE_BALANCE, $claimClaimableBalanceOp))
    ...
    public function toXdr(XDR &$xdr): void
    {
        if (!isset($this->balanceId)) {
            throw new InvalidArgumentException('The claim claimable balance operation is missing a balance Id');
        }
    ...
    public static function newFromXdr(XDR &$xdr): static
    {
        ...
        $createClaimableBalanceOp->balanceId = $xdr->read(ClaimableBalanceId::class);
    ...
    /**
     * Accept a balance Id. If given a string we will assume it is hexadecimal.
     *
